    ...
    return (
        <View className="flex-1 bg-white">
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View className="absolute top-10 left-3 right-3">
                    <View className="flex-row items-center justify-between px-4 pt-2">
                        ...
                        >
                            <Ionicons name="arrow-back" size={20} color="#FFFFFF" className='font-bold' />
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={toggleSave}
                ...
                <Text className="text-base font-bold text-gray-900 mb-2 px-4">
                    Description
                </Text>
                <Text className="text-gray-500 text-sm leading-6 mb-1 px-4">
                    {displayDesc}
                </Text>
                {isLongDesc && (
                ...
                <TouchableOpacity
                    ...
                    className="flex-row items-center justify-center gap-2 bg-green-500 py-4 rounded-2xl mb-4 mx-4"
                >
                ...
                {isAdmin && (
                    <View className='flex-row gap-3'>{!property.is_sold && (
                        <TouchableOpacity
